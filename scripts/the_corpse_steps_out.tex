...
\begin{parascale}[2]
\vspace*{3\nbs}
\centering\charscale[0.75]{\MakeUppercase{The Corpse}}\par
\centering\charscale[0.75]{\MakeUppercase{Steps Out}}\par
\end{parascale}
\clearpage
\thispagestyle{empty}
...
\begin{parascale}[1]
\vspace*{3\nbs}
\centering\charscale[2]{\MakeUppercase{By Craig Rice}}\par
\end{parascale}
\vfill
\begin{parascale}[1]
...
% Copyright Page.
\null\vfill
\allsmcp{First edition} Simon \&amp; Schuster, March 1940 (First printing February 1940). \\Two Complete Detective Books edition published January 1944. \\Tower edition published July 1945 (1st printing June 1945). \\Pocket Books edition published November 1945 (1st printing October 1947).\par
\null\null
\allsmcp{ISBN}\par
\null\null
\vfill
