...
\begin{parascale}[1]
\centering\charscale[2]{Bruno Fischer}\par
\end{parascale}
\vfill
\begin{parascale}[1]
\centering\InlineImage[0, 3em]{/run/media/h/T7 Shield/dox/2_Pulpeteers-Press/Tales of Murder/2024/assets/atticus.jpg}
...
% Copyright Page.
\null\vfill
\noindent\allsmcp{First published}:\\\textit{Mammoth Magazine} Jan. 1946 | Vol. 2, No. 1\par
\null\null
\noindent\allsmcp{MBIN: b05622c343aa-P}
\vfill

\noindent\textit{This novel is in the public domain.} \\ Certain \mbox{elements} in this edition are \\ Copyright © 2019 Tales of Murder Press, LLC
...
\tocitem*[2]{Yesterday and Today}{10}
\tocitem*[3]{Blood on the Lily}{21}
\tocitem*[4]{The Jail}{36}
\tocitem*[5]{For the People}{57}
\tocitem*[6]{For Me}{80}
\tocitem*[7]{The Verdict}{103}
\tocitem*[8]{Sypathetic People}{108}
\tocitem*[9]{Afternoon of the Mathmetician}{122}
\tocitem*[10]{Negotiation for a Name}{138}
\tocitem*[11]{Poker}{150}
\tocitem*[12]{Emil Schneider}{164}
\tocitem*[13]{Flight}{174}
\tocitem*[14]{Shadows and Spectors}{191}
\tocitem*[15]{The Gamblers}{204}
\tocitem*[16]{Don Yard}{217}
\tocitem*[17]{Pursuit of an Equation}{235}
\tocitem*[18]{The Pay-Off}{252}
\tocitem*[19]{The Return}{274}
\tocitem*[20]{Q.E.D.}{289}
\end{toc}
\clearpage
...
\ChapterTitle[l]{Returning Home}
\end{ChapterStart}
\FirstLine{\noindent She wasn’t there. I paused on the lowest step and looked past the two women running toward me. Lily wasn’t anywhere on the narrow station platform.}
...
\end{ChapterStart}
\FirstLine{\noindent The dinette was separated from the living room by an arch and a step. When I raised my eyes from the table,
...
\ChapterTitle[l]{Blood on the Lily}
\end{ChapterStart}
\FirstLine{\noindent There were subdued voices in the living room. I went in there instead of down to the basement. On the couch in front of the dead fireplace Bevis Spencer was holding Miriam’s hand. He turned his head sharply when he heard me and dropped her hand in confusion and clambered up to his feet.}
...
\ChapterTitle[l]{The Jail}
\end{ChapterStart}
\FirstLine{\noindent Ursula stopped inside the cell and sent a startled, shocked glance over her shoulder at the door closing behind her. Then she kissed me quickly on the mouth and thrust a package into my hands, like an embarrassed little girl presenting a gift at a birthday party.}
...
\end{ChapterStart}
\FirstLine{\noindent Sunlight poured in through one of the tall courtroom windows and lay warmly over the long table at which I sat. When I held my hands in the dusty streamers, shadows formed on the table, and with my fingers I fashioned animated images of ducks and goblins.}
...
\end{ChapterStart}
\FirstLine{\noindent Ursula wore a black-and-white print dress and a black cartwheel hat. She looked chic, as the fashion magazines put it, but not so obtrusively smart that the rather dowdy women jurors would resent her.}
...
\end{ChapterStart}
\FirstLine{\noindent I kept my eyes fixed on an inkspot on the table, but there was no getting away from Robin Magee’s voice.}
...
\end{ChapterStart}
\FirstLine{\noindent That Saturday morning I took two showers. During the second shower I heard Ursula go out to the back yard and Miriam wasn’t home, so I walked naked up the hall to my room.}
...
\ChapterTitle[l]{Afternoon of a Mathematician}
\end{ChapterStart}
\FirstLine{\noindent Bevis Spencer tapped on my shoulder while I was waiting with my basket wagon at one of the checking counters.}
...
\ChapterTitle[l]{Negotiation for a Name}
\end{ChapterStart}
\FirstLine{\noindent I left the house through the back door when I heard some of the poker players at the front door. Ursula had asked me to go easy on using the car because she was short on gas coupons, but I didn’t intend to drive far.}
...
\end{ChapterStart}
\FirstLine{\noindent Miriam and Ursula came out on the porch when they heard our cars. I remained seated behind the wheel without will to move. Kerry got out of his car and walked stiff-legged to my window, like a traffic cop about to hand out a ticket. He opened the door.}
...
\end{ChapterStart}
\FirstLine{\noindent It was one of the better public clubs.}
...
\end{ChapterStart}
\FirstLine{\noindent  Walter was waiting for me on Madison Avenue. He said tonelessly: “Around the corner.”}
...
And he moved the rook to \allsmcp{KB5} instead of to \allsmcp{KB6}, which would have been proper.
...
\end{ChapterStart}
\FirstLine{\noindent That week there were three more floating games in hotel rooms. I did very well in one and fair in the two others. But I got nowhere at all in the real purpose behind my playing. I saw Don Yard only at the pay-offs and then briefly. Tackling Walter, I had learned, was a waste of breath, if not hazardous. Bertha Kaleman seemed to be my best bet, but I couldn’t get her off by herself. Twice I phoned the unlisted number to ask her out to lunch. The first time there was no answer. The second time I hung up as soon as I heard Yard’s voice over the wire.}
...
\noindent\midcase{Let X=the Suspect.}

\noindent\midcase{Let OL=Opportunity to murder Lily.}

\noindent\midcase{Let KL=Knowledge of my movements in Lily’s murder.}

\noindent\midcase{Let ML=Motive for murdering Lily.}

\noindent\midcase{Let ...}

I left it there and went into the bathroom to shave. I returned to the dresser and picked up my pen. There were eight terms in all. I didn’t finish the summary. I could see which was the only one of the ten \midcase{X}’s the equation could satisfy.
...
\ChapterTitle[l]{The Pay-Off}
\end{ChapterStart}
\FirstLine{\noindent I reached the theater after the first act curtain and in darkness sidled past Walter and Don Yard and Bertha and sat in the empty seat on her right. Her fingers groped for my hand and stroked it. I snatched my hand away. Was she crazy, with Don Yard sitting on the other side of her?}
...
He would say: And you are convinced that this proves that \midcase{X} murdered Lily Linn and Emil Schneider?

I would say: I am.

He would say: Marvelous! This will revolutionize police science. All we will have to do in the future is to have \midcase{X} equal a formula and we’ll have our criminal.
...
He would say: All the same, I thank you. It will make me ashamed to collect my pay for the next month. I will merely have to read your equation to a jury and the conviction of \midcase{X} will follow automatically. Any little thing I can do for you to express my gratitude?
...
\end{ChapterStart}
\FirstLine{\noindent The white dress revealed her seated on the top porch step. Her hand lifted to the darker shadow that was her face. The cigarette glowed as she drew on it, momentarily highlighting her features in a soft blur.}
...
\noindent Let \midcase{X} = the Suspect.

\noindent Let \midcase{KL} = Knowledge of Alec’s movements before Lily’s murder.

\noindent Let \midcase{KS} = Knowledge of Alec’s movements before Schneider’s murder.

\noindent Let \midcase{OL} = Opportunity to murder Lily.

\noindent Let \midcase{OS} = Opportunity to murder Schneider.

\noindent Let \midcase{ML} = Motive to murder Lily.

\noindent Let \midcase{MS} = Motive to murder Schneider.

\noindent Let \midcase{MA} = Motive to frame Alec for both murders.

\noindent Therefore:

\noindent\midcase{X = KL + KS + OL + OS + ML + MS + MA.}
...
"As I knew that I was innocent, I concluded that both murders were deliberately planned to implicate me. There you have the terms, \midcase{KL} and \midcase{KS}, which limit \midcase{X}, the suspect, to those persons who were in this house during the card games on the two Saturday nights of the murders.

"Which brings us to \midcase{OL} and \midcase{OS}. Everybody who was here the night Lily was murdered could have beaten me to the bungalow. \midcase{OS} eliminated Miriam and Ursula; they were here when I drove away, but the rest had already departed.

"As for \midcase{ML} and \midcase{MS}—a number of you had reason to hate Lily or want her out of the way, and there could have been other motives that I was unaware of. \midcase{ML} was the least fixed of all the terms, just as \midcase{MS} was the most definitely fixed on the reasonable assumption that Schneider’s murder flowed out of Lily’s, that he was killed because he had seen who murdered Lily and tried to capitalize on it.

"In effect, \midcase{ML} and \midcase{MS} are connected terms. Satisfy the first and the second is automatically satisfied.”

“Symbols and words!” George exploded. “Anybody can write an equation.”

“Give Alec a chance,” Kerry snapped at him. He looked at me. “Where does the \midcase{MA} term come in. I can’t see it.”

“That was the crux of the equation,” I said. “It had me stumped for a long time. \midcase{MA} flows inevitably from the other terms. Motive for mortally hurting me. Not killing me.
...
"That’s still the most foolproof way to murder somebody—shoot or stab and go home. No, \midcase{X} was somebody who hated me, but had reason for not wanting me dead or not wanting me dead by his own hands.”
...
“I went to New York because I had to go somewhere. It was as good as anywhere else, and Don Yard was there. I didn’t think that he—or even less likely, Bertha Kaleman—had murdered Lily. \midcase{KL} and \midcase{KS} excluded them, but not wholly. Coincidences occur, however improbable. They both had plenty of reason to do away with Lily, and at the time Yard was the only one I could think of who hated me enough to frame me.

"I had to be sure of facts concerning him before I could limit the equation to \midcase{KL} and \midcase{KS}. And I learned that he and Bertha were on Cape Cod the night of the murder. But that was only part of what I was after—the least part. Yard had maintained some sort of contact for all I knew, intimacy—with Lily while I was overseas, and there was a chance that he or Bertha or Walter could supply me with information which would help. I did get something from Bertha, a sort of proof of the equation. Somebody in West Amber threatened Lily’s life a couple of days before she was murdered—somebody who was not a lover or had any personal relationship with her.”
...
\end{ChapterStart}
\FirstLine{\noindent For a long minute I stood on the road recalling where each room in the sprawling house was located. The only light was in the largest of the wings, the living room. A voice drifted out to me, unctuous, modulated—a radio voice.}
...
“Ursula and Miriam had knowledge of my movements before each murder and conceivably had reason to murder Lily. But \midcase{OS} and \midcase{MA} don’t cancel out against their names. They couldn’t have murdered Schneider; they’d been in the house when I’d left and I’d driven straight there. And, of course, I couldn’t see either of them wanting to hurt me.

“As for Sheriff Dowie, he wasn’t at the second poker game, so \midcase{KS} doesn’t cancel out, and, as far as I know, \midcase{ML} and \midcase{MS} and \midcase{MA} don’t. Kerry and George Winkler, both with full knowledge and opportunity, are left with \midcase{ML} and \midcase{MS} and \midcase{MA}. The motive was the tricky part, the most unfixed of the terms. There could be facts beyond my knowledge, but I had to go along with what I had.

“Finally you three Spencers. Helen saw her father knocked down by Don Yard because of Lily, and perhaps for that, and other reasons, hated her. It doesn’t matter. She wasn’t at the house just before Schneider’s murder, so \midcase{KS} doesn’t cancel, nor does \midcase{MS}. You, Mr. Spencer, and Bevis were in both poker games and had opportunity after each of them and resented or disliked or hated Lily because of what she was doing to Helen. Not strong motive for murder, but assuming it was sufficient, neither of you cancelled out \midcase{MA}. Why should you or Bevis, or anybody, want to frame me? That was the chief snag until a few days ago.”
...
“Is this the state police?” he said. “My son—”

I kept going. It was a clear, mild night. The high, \mbox{lopsided} moon had the sky to itself. I pulled my flashlight out of my hip pocket and walked home to Miriam.
...
\clearpage
% Title Page.
{\centering\textsc{--- free sample ---}\par}
\null\null\null\null\null\null

\begin{parascale}[4]
\centering{AND SUDDEN DEATH}\par
\end{parascale}
\vspace*{4\nbs}

\begin{parascale}[1]
\centering\charscale[2]{Cleve F. Adams}\par
\end{parascale}
\vfill
...
\clearpage % because ToC must st\clearpage % because ToC must start recto
\thispagestyle{empty}
\begin{toc}[0]{0em}
{\centering\charscale[1.25]{Contents}\par}
\null
\tocitem*[1]{I'm the Guy}{1}
\tocitem*[2]{The Nordstrom File}{8}
\tocitem*[3]{"Honolulu"}{18}
\tocitem*[4]{All Aboard}{31}
\tocitem*[5]{Kay Ford}{41}
\tocitem*[6]{Simmons}{48}
\tocitem*[7]{Man Overboard}{60}
\tocitem*[8]{Radiograms}{67}
\tocitem*[9]{Cabin 411}{73}
\tocitem*[10]{A Potential Thief}{78}
\tocitem*[11]{The Diver}{84}
\tocitem*[12]{Love and Murder}{93}
\tocitem*[13]{Our Chief Suspect}{101}
\tocitem*[14]{Itsuki}{108}
\tocitem*[15]{Itsuki's Valet}{114}
\tocitem*[16]{"You Always Get Yours"}{119}
\tocitem*[17]{The Lady}{128}
\tocitem*[18]{Six Raw Eggs}{134}
\tocitem*[19]{Honolulu}{148}
\tocitem*[20]{Bull in the China Shop}{155}
\tocitem*[21]{Dames with Guns}{165}
\tocitem*[22]{You Shot George Teal}{171}
\tocitem*[23]{The Sound of a Shot}{179}
\tocitem*[24]{Nordstrom}{192}
\tocitem*[25]{A Japanese Voice}{200}
\tocitem*[26]{Seven Boys with Steel Guitars}{212}
\end{toc}
\clearpage
...
\vspace{3\nbs}
\ChapterSubtitle[l]{Chapter 1}
\ChapterTitle[l]{I’m the Guy}
\end{ChapterStart}
\FirstLine{\noindent If McBride had not wanted to get out of town anyway he probably wouldn’t have taken the job.}
...
\vspace{3\nbs}
\ChapterSubtitle[l]{Chapter 2}
\ChapterTitle[l]{The Nordstrom File}
\end{ChapterStart}
\FirstLine{\noindent The city room of the \textit{Tribune} was a hive of industry. McBride, who disliked hives of industry, and city rooms in particular, took a deep breath before letting the swing doors close behind him.}
...
\centering{Get AND SUDDEN DEATH \& more great murder mystery, crime, \& detective stories at:}\par
